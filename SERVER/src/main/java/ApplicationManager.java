...
import executors.RepositoryOfLabwork;
import treatment.GetFromClient;
...
/**
 * Класс, в котором происходят инициализация объектов, отвечающих за работу приложения
...
public class ApplicationManager extends Thread implements MessageErrors {
    ...
    private RepositoryOfLabwork repositoryOfCity;
    ...
    public void begin() throws IOException {
        ...
        repositoryOfCity = new RepositoryOfLabwork(dataBase);
        ...
        while (true) {
            ...
            if (selector.isOpen()) {
                try {
                    ...
                    System.out.println("Серверу стало плохо. IOException");
                    break;
                }
            } else {
